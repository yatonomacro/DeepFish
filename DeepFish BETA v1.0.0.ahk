...
HudBarW() {
	global BarWTrust, WhiteBarSize, RunWidth, HudWMed
	if (WhiteBarSize > 8)
		return WhiteBarSize
	if (HudWMed > 8)
		return HudWMed
...
NoteScan(refX) {
	global FishBarLeft, FishBarRight, NoteOriginX, NoteLockX, LastNoteX, NoteDbgCalls, NoteMissN
...
CastboundScan() {
	...
	global CastPrevL, CastPrevW, CastPrevF, CastSameN, CastStatic
	if (CastScanned)
		return CastFound
	CastScanned := true
	CastFound := false
...
Gui, Add, Text, x22 y42 w320 h16 HwndhSubtitle, Version 1.0.0  •  Made by Yato
...
Gui, Font, s9 Norm cFFFFFF, Segoe UI
Gui, Add, Text, x%CX% y162 w%TXW% h18 HwndhAbtVer, Version 1.0.0  •  Made by Yato
