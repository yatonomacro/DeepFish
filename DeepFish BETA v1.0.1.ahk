...
if (!DFVersionNewer(DFLatest, DFBetaVersion))
	return
MsgBox, 0x1024, DeepFish Update Available, % "A new version of DeepFish is available.`n`nYou have: " . DFBetaVersion . "`nLatest: " . DFLatest . "`n`nOpen the download page now?"
IfMsgBox, Yes
