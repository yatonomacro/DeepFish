...
BarCalcLimit := MgFightMode ? Max(BarCalculationFailsafe, 240) : BarCalculationFailsafe
...
NumPut(-(CaptureH + 38), CaptureBMI, 8, "Int")
...
Gui, Add, Text, x22 y42 w320 h16 HwndhSubtitle, Version 1.0.2  •  Made by Yato
...
Gui, Font, s9 Norm cFFFFFF, Segoe UI
Gui, Add, Text, x%CX% y162 w%TXW% h18 HwndhAbtVer, Version 1.0.2  •  Made by Yato
